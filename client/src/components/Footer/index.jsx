    ...
    return (
        <div className="footer container-fluid">
            <Row className='container-fluid' style={{ margin: '0px', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <Col md='4' className="footer-text">
                    <h3>Licensed under <a href="https://opensource.org/licenses/mit-license.php">MIT</a></h3>
                </Col>
                <Col md='4' className="footer-text">
                    <Col>
                    <a className='github' href="https://github.com/PeteChicchetti/technigram" target="_blank" rel="noopener noreferrer"><AiFillGithub /></a>
                    </Col>
                </Col>
            </Row>
        </div>
