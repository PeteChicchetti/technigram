        ...
        <div className="footer container-fluid">
            <Row className='footer-row container-fluid' style={{ margin: "0px" }}>
                <Col md='4' className="footer-text">
                    <h3 className="developers">Made by: <a href="https://github.com/ThatBallinGuy">Tristan Ballin</a>, <a href="https://github.com/PeteChicchetti">Pete Chicchetti</a>, <a href="https://github.com/BenjaminCottrell">Ben Cottrell</a>, and <a href="https://github.com/StyngerBee">Curran Duke</a>.</h3>
                </Col>
                <Col md='4' className="footer-text">
